  ...
  begin
    users.each do |user|
      ...
      if obj.length > 0
        ...
        puts("No local user hashes.  System is likely a DC")
      end
...
unless ARGV.length > 1
  puts "Dumps local password hashes.  Requires a copy of the target's SYSTEM and SAM registry hive.\r\n"
	puts "\tUsage: ./hashdump.rb [System Hive] [Sam Hive]\r\n\r\n"
	exit!
end
